<template>
  <UCard>
    ...
    <div class="p-6 rounded-xl dark:bg-gray-800/75 mb-3 bg-gray-200">
      <div class="p-6 rounded-xl dark:bg-gray-800/75 mb-3 bg-gray-200 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
      <div>
        <h3 class="dark:text-white font-semibold text-sm">Nama Pasien</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.nama_pasien ?? "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">No. Rekam Medis</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.nomr ?? "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">Tanggal Lahir</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.tanggal_lahir ? new Date(data.data[0].tanggal_lahir).toLocaleDateString('id-ID', { day: '2-digit', month: 'long', year: 'numeric' }) : "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">No. HP</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.notelep ?? "-" }}</p>
      </div>
      <div class="lg:col-span-2">
        <h3 class="dark:text-white font-semibold text-sm">Alamat</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.pasien?.alamat ?? "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">Kepesertaan</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.peserta ?? "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">No. BPJS</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.no_kartu ?? "-" }}</p>
      </div>
      <div>
        <h3 class="dark:text-white font-semibold text-sm">NIK KTP</h3>
        <p class="dark:text-gray-300 font-medium">{{ data?.data[0]?.pasien?.no_ktp ?? "-" }}</p>
      </div>
    </div>
    </div>
